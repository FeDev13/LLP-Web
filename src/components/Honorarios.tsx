export const Honorarios = () => {
  return (
    <div className=" h-screen">
      <h2 className="text-5xl mt-8 text-white">Honorarios</h2>
      ...
      <h2 className="mt-5 text-3xl underline text-white">
        Honorarios por consultas segun ley 14.967
      </h2>
      <div className="flex justify-between mt-8">
        <p className="ml-20 text-2xl text-white">Consulta verbal</p>
        <p className="mr-20 text-2xl text-white">1 ius</p>
      </div>
      <div className="flex justify-between mt-8">
        <p className="ml-20 text-2xl text-white">Consulta escrita</p>
        <p className="mr-20 text-2xl text-white">2 ius</p>
      </div>
    </div>
  );
};

    ...
    <><div className="navbar bg-black sticky top-0 flex z-10 h-20">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-black rounded-box w-96 text-2xl mr-52">
      ...
      <div className="navbar-center hidden lg:flex">
        ...
        <ul className="menu menu-horizontal px-1 text-white uppercase text-3xl">
          ...
          <ReactWhatsapp number="+5492235044778" element="button" message=""><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-whatsapp ml-4" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
